...
export const WordmarkReveal: React.FC<WordmarkRevealProps> = ({ isInstant = false }) => {
  // SVG path coordinates for MAHOTSAV extracted from the official PDF
      ...
      <div className="relative w-full flex items-center justify-center my-0.5 sm:my-1">
        ...
        <div className="w-[82%] sm:w-[85%] md:w-[88%] max-w-[620px] filter drop-shadow-[0_8px_20px_rgba(28,5,10,0.85)]">
          <svg
            ...
            aria-label="MAHOTSAV Wordmark"
          >
            <defs>
              <linearGradient id="mahotsavFill" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="#4A0E17" />
                <stop offset="45%" stopColor="#2E0910" />
                <stop offset="100%" stopColor="#1C050A" />
              </linearGradient>
              <linearGradient id="goldOutline" x1="0%" y1="0%" x2="100%" y2="0%">
